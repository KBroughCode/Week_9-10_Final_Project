...
const mapDispatchToProps = (dispatch) => ({
  getDeck() {
    dispatch(() => {
      fetch(`https://deckofcardsapi.com/api/deck/new/shuffle/?cards=AS,AH,AC,AD,2S,2H,2D,2C,3S,3H,3D,3C,4S,4H,4C,4D,5S,5H,5C,5D,6S,6H,6D,6C,7S,7H,7D,7C,8D,8C,8S,8H,9D,9C,9S,9H,0D,0C,0S,0H,JD,JC,JH,JS,QS,KS,KH,KD,KC`)
      .then(res => res.json())
      .then(deck => {
